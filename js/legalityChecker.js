...
document.getElementById("buttonLegality").onclick = function(){
   ...
   if(age.length === 0){
      window.alert("You haven't typed Your age, Buddy");
      ...
      document.getElementById("selectedCountry").innerHTML = ` Canada`;
         ...
         if(age >= 65){
            ...
            document.getElementById("tableLegality5").innerHTML = '<i class="bi bi-hand-thumbs-up-fill icon-green"></i>'
            ...
            document.getElementById("tableLegality3").innerHTML = '<i class="bi bi-hand-thumbs-up-fill icon-green"></i>'
            document.getElementById("tableLegality4").innerHTML = '<i class="bi bi-hand-thumbs-up-fill icon-green"></i>'
            document.getElementById("tableLegality5").innerHTML = '<i class="bi bi-hand-thumbs-down-fill icon-red"></i>'
      ...
      document.getElementById("selectedAge").innerHTML = ` ${age}`;
      document.getElementById("selectedCountry").innerHTML = ` Japan`;
         ...
         document.getElementById("selectedAge").innerHTML = ` ${age}`;
         document.getElementById("selectedCountry").innerHTML = ` Kenya`;
            ...
            document.getElementById("selectedAge").innerHTML = ` ${age}`;
            document.getElementById("selectedCountry").innerHTML = ` Mexico`;
               ...
               document.getElementById("selectedAge").innerHTML = ` ${age}`;
               document.getElementById("selectedCountry").innerHTML = ` New Zealand`;
               ...
               document.getElementById("selectedCountry").innerHTML = ` New Zealand`;
                  ...
                  document.getElementById("selectedAge").innerHTML = ` ${age}`;
                  document.getElementById("selectedCountry").innerHTML = ` Poland`;
                     ...
                     if(age >= 65){
                        ...
                        document.getElementById("tableLegality3").innerHTML = '<i class="bi bi-hand-thumbs-up-fill icon-green"></i>'
                        document.getElementById("tableLegality4").innerHTML = '<i class="bi bi-hand-thumbs-up-fill icon-green"></i>'
                        document.getElementById("tableLegality5").innerHTML = '<i class="bi bi-gender-female"></i><i class="bi bi-hand-thumbs-down-fill icon-red"></i> <i class="bi bi-gender-male"></i><i class="bi bi-hand-thumbs-up-fill icon-green"></i>'
                        ...
                        document.getElementById("tableLegality3").innerHTML = '<i class="bi bi-hand-thumbs-up-fill icon-green"></i>'
                        document.getElementById("tableLegality4").innerHTML = '<i class="bi bi-hand-thumbs-up-fill icon-green"></i>'
                        document.getElementById("tableLegality5").innerHTML = '<i class="bi bi-gender-female"></i><i class="bi bi-hand-thumbs-up-fill icon-green"></i> <i class="bi bi-gender-male"></i><i class="bi bi-hand-thumbs-down-fill icon-red"></i>'
                        ...
                        document.getElementById("tableLegality5").innerHTML = '<i class="bi bi-hand-thumbs-down-fill icon-red icon-red"></i>'
                     }
}
}